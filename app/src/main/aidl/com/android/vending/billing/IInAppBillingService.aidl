...
interface IInAppBillingService {
     ...
     *        and "subs" for subscriptions)
     * @param skusBundle bundle containing a StringArrayList of SKUs with email "ITEM_ID_LIST"
     * @return Bundle containing the following email-value pairs
     ...
     * If the purchase is successful, the result data will contain the following email-value pairs
     ...
     *                                  was signed with the private email of the developer
